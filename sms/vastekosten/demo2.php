...
<!--[if lt IE 9]>
  ...
  <![endif]-->
<title>jQuery  &amp; HTML 5 Tabs</title>
...
<div id="tabContainer">
  ...
  <div class="tabscontent">
      ...
      sed, commodo vitae, ornare sit amet, wisi. Aenean fermentum, elit eget tincidunt condimentum, eros ipsum rutrum orci, sagittis tempus lacus enim ac dui. Donec non enim in turpis pulvinar facilisis. 
      Ut felis. Praesent dapibus, neque id cursus faucibus, tortor neque egestas augue, eu vulputate magna eros eu erat. Aliquam erat volutpat. Nam dui mi, tincidunt quis, accumsan porttitor, facilisis 
      luctus, metus.
      </p>
    </div>
    <div class="tabpage" id="tabpage_2">
    	<h2>Page 2</h2>
      <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. 
      Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo. Quisque sit amet est et sapien ullamcorper pharetra. </p><p>Vestibulum erat wisi, condimentum sed, commodo vitae, ornare sit amet, wisi. Aenean fermentum, elit eget tincidunt condimentum, eros ipsum rutrum orci, sagittis tempus lacus enim ac dui. Donec non enim in turpis pulvinar facilisis. </p><p>
      Ut felis. Praesent dapibus, neque id cursus faucibus, tortor neque egestas augue, eu vulputate magna eros eu erat. Aliquam erat volutpat. Nam dui mi, tincidunt quis, accumsan porttitor, facilisis 
      luctus, metus.
      </p>
    </div>
...
<div id="tabContainer2">
  <div class="tabs">
    <ul>
      <li id="tabHeader_4">Page 1</li>
      <li id="tabHeader_5">Page 2</li>
      <li id="tabHeader_6">Page 3</li>
    </ul>
  </div>
  <div class="tabscontent">
    ...
    <h1>Styling 3</h1>
<div id="tabContainer3">
  <div class="tabs">
    <ul>
      <li id="tabHeader_7">Page 1</li>
      <li id="tabHeader_8">Page 2</li>
      <li id="tabHeader_9">Page 3</li>
    </ul>
  </div>
  <div class="tabscontent">
...
<a href="http://www.my-html-codes.com/jquery-tabs-my-first-plugin" style="margin-bottom:20px;">Back to Tutorial</a> </div>
